...
public class Medic extends Personal {
    ...
    public boolean equals(Object o) {
        ...
        Medic medic = (Medic) o;
        return salariu == medic.salariu &&
                sporuri == medic.sporuri &&
                experinta == medic.experinta &&
                size == medic.size &&
                capacity == medic.capacity &&
                Objects.equals(specializare, medic.specializare) &&
                Arrays.equals(programari, medic.programari);
    }

    @Override
    public int hashCode() {
        int result = Objects.hash(salariu, sporuri, specializare, experinta, size, capacity);
        result = 31 * result + Arrays.hashCode(programari);
        return result;
    }
}